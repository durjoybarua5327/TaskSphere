...
export function StudentProfileClient({ profile: initialProfile, posts, currentUserId, isOwnProfile = true }: StudentProfileClientProps) {
    ...
    const handleEditProfile = () => {
        openModal({
            type: "edit",
            title: "Edit Profile",
            description: "Update your personal and details",
            className: "max-w-xl",
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                                    <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border transition-all duration-300 ${profile.is_super_admin
                                        ...
                                        {profile.is_super_admin ? 'Global Admin' : (profile.role || 'Student').replace('_', ' ')}
                                    </span>
                                </div>
