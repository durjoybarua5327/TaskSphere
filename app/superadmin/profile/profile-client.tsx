                        ...
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                                    <span className="px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest bg-green-50 text-green-700 border border-green-100 shadow-sm transition-all duration-300">
                                        Global Admin
                                    </span>
                                </div>
                                <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-tight mb-3">
                                    {profile.full_name || "Global Admin"}
                                </h2>
                            </div>
...
function InfoCard({
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-[1.5rem] p-5">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-black mb-0.5">
                        {label}
                        {isReadOnly && (
                            <span className="ml-2 text-[8px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded border border-slate-200">LOCKED</span>
                        )}
                    </p>
                    <p className="text-sm font-bold text-slate-700 truncate max-w-[200px]">{value}</p>
                </div>
            </div>
        </div>
    );
